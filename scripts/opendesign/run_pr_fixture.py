...
Runs every fixture event through the dispatcher and prints a JSON
summary. Designed to be called from the GitHub Actions workflow via
`workflow_dispatch` (so the same workflow can be exercised in PR review
without waiting for a real `issue_comment` event).
...
from opendesign import runner as R  # noqa: E402
from opendesign import contract as C  # noqa: E402
from opendesign.dispatch_stub import StubTransport  # noqa: E402
