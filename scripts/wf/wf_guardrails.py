...
SILENT_EXCEPTION_ALLOWLIST = [
    ...
    {"file": "pasay-telegram-bot/pasay_bot/handlers/callback.py", "line": 219,
     "kind": "silent_pass",
    ...
    {"file": "pasay-telegram-bot/pasay_bot/handlers/callback.py", "line": 266,
     "kind": "silent_pass",
    ...
    {"file": "pasay-telegram-bot/pasay_bot/handlers/callback.py", "line": 276,
     "kind": "silent_pass",
     "reason": "Handler-latency instrumentation is telemetry, not user-visible "
               "output; it must never break the UX path."},
    {"file": "pasay-telegram-bot/pasay_bot/handlers/commands.py", "line": 772,
     "kind": "silent_pass",
    ...
    {"file": "pasay-telegram-bot/pasay_bot/handlers/commands.py", "line": 972,
     "kind": "silent_pass",
    ...
    {"file": "pasay-telegram-bot/pasay_bot/handlers/commands.py", "line": 976,
     "kind": "silent_pass",
     "reason": "Dashboard lease enrichment is optional; core dashboard data "
               "renders."},
    {"file": "pasay-telegram-bot/pasay_bot/handlers/commands.py", "line": 1210,
     "kind": "silent_pass",
    ...
    {"file": "pasay-telegram-bot/pasay_bot/handlers/nl_bridge.py", "line": 762,
     "kind": "silent_pass",
